...
public class ClickingOrderMinigameController : MinigameController
{
    ...
    public override void Launch(PlayerController interactingPlayer)
    {
        ...
        {
            new InputButton(interactingPlayer.minigameButtonsActions[0], clickingOrderController.Click, 0),
            new InputButton(interactingPlayer.minigameButtonsActions[1], clickingOrderController.Click, 1),
            new InputButton(interactingPlayer.minigameButtonsActions[2], clickingOrderController.Click, 2),
            new InputButton(interactingPlayer.minigameButtonsActions[3], clickingOrderController.Click, 3)
        };
    ...
    public override void Hide()
    {
        ...
        clickingOrderController.Restart();
