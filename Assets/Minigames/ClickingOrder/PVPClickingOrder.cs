...
public class PVPClickingOrder : PVPMinigameController
{
    ...
    public override void Launch(PlayerController playerLeft, PlayerController playerRight)
    {
        ...
        {
            new InputButton(playerLeft.minigameButtonsActions[0], clickingOrderController1.Click, 0),
            new InputButton(playerLeft.minigameButtonsActions[1], clickingOrderController1.Click, 1),
            new InputButton(playerLeft.minigameButtonsActions[2], clickingOrderController1.Click, 2),
            new InputButton(playerLeft.minigameButtonsActions[3], clickingOrderController1.Click, 3)
        };
        inputsList2 = new List<InputButton>()
        {
            new InputButton(playerRight.minigameButtonsActions[0], clickingOrderController2.Click, 0),
            new InputButton(playerRight.minigameButtonsActions[1], clickingOrderController2.Click, 1),
            new InputButton(playerRight.minigameButtonsActions[2], clickingOrderController2.Click, 2),
            new InputButton(playerRight.minigameButtonsActions[3], clickingOrderController2.Click, 3)
        };
    ...
    public override void Hide()
    {
        ...
        inputsList1.Clear();
        inputsList2.Clear();
        clickingOrderController1.Restart();
        clickingOrderController2.Restart();
